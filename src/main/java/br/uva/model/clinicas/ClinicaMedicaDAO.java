...
public interface ClinicaMedicaDAO extends CrudRepository<ClinicaMedica, Long> {
	Page<ClinicaMedica> findDistinctByLogradouroInIgnoreCaseOrNomeInIgnoreCaseOrEspecialidadesIn(Collection<String> logradouro, Collection<String> busca, Collection<Especialidade> especialidade, Pageable pr);
	Page<ClinicaMedica> findDistinctByLogradouroInIgnoreCaseOrNomeInIgnoreCaseOrEspecialidadesInAndTipoAtendimento(Collection<String> logradouro, Collection<String> busca, Collection<Especialidade> especialidade, TipoAtendimento tipoAtendimento, Pageable pr);
